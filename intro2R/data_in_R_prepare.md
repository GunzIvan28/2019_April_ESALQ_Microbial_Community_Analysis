...
```r
download.file("https://raw.githubusercontent.com/ucdavis-bioinformatics-training/2019_April_ESALQ_Microbial_Community_Analysis/master/intro2R/Data_in_R_files/bwa_mem_Stats.log", "bwa_mem_Stats.log")
```
...
```r
download.file("https://raw.githubusercontent.com/ucdavis-bioinformatics-training/2019_April_ESALQ_Microbial_Community_Analysis/master/intro2R/data_in_R.Rmd", "data_in_R.Rmd")
```
...
You can view the output of plot-bamstats -> <https://rawgit.com/ucdavis-bioinformatics-training/2019_April_ESALQ_Microbial_Community_Analysis/master/intro2R/Data_in_R_files/bwa_mem_Stats/bwa_mem_Stats.html>
